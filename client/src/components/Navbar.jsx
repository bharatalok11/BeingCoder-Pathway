      ...
      <div className="container mx-auto px-6 py-3">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="/reviews" className="text-gray-700 hover:text-[#0077b6] font-medium transition duration-300 cursor-pointer">Contact Us</a>
        ...
        {isOpen && (
          <div className="md:hidden bg-white mt-3 py-3 rounded-lg shadow-lg">
            ...
            <a href="/contact" className="block px-4 py-2 text-gray-700 hover:bg-[#caf0f8] hover:text-[#0077b6] font-medium transition duration-300 cursor-pointer">Contact Us</a>
